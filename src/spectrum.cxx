...
spectrum_1D::spectrum_1D ( string name_root, string title, int nr_of_bins,
                           double first_channel,
                           double last_channel, string folder, string note, const string list_incrementers )

{
  //cout << "Constructor for Spectrum: " << name_root << endl ;
  //last_channel_paper = 66 ; //ast_channel;
  max_bin = 0 ;
//   cout << "name_root=" << name_root << ", title= " << title
...
void spectrum_1D::create ( string name_root, string title, int nr_of_bins,
                           double first_channel,
                           double last_channel, string folder, string note, string list_of_incrementers )
{
//     cout << "Constructor for Spectrum: " << name_root << endl ;
...
//************************************************************************
//************************************************************************
spectrum_2D::spectrum_2D ( string  name_root, string  title,
          ...
          if ( ptr_root_spectrum->GetBinContent ( x, y ) > 32000 )
            {
              ...
              //cout << "Saving 32 bit spectrum " << name_s << endl;
              break;
            }
        }
    }
...
//***********************************************************************
/** No descriptions */
void spectrum_2D::manually_increment_by ( int x, int y, int value )
{
